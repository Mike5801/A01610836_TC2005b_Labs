...
const rutasModulo1 = require('./routesLab12/rutas_modulo1');
const rutasModulo2 = require('./routesLab12/rutas_modulo2');
const rutasModulo3 = require('./routesLab12/rutas_modulo3');
const rutasModulo4 = require('./routesLab12/rutas_modulo4');
