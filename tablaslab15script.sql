...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-04-2022 a las 01:15:53
...
--
-- Base de datos: `tablaslab15script`
--
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `aumentoPrecioProducto` (IN `U_Inflacion` FLOAT, IN `U_Clave` INT)  UPDATE materiales SET precio = precio + U_Inflacion$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `registrarEntrega` (IN `U_clave` INT, IN `U_rfc` VARCHAR(100) CHARSET utf8, IN `U_numero` INT, IN `U_fecha` DATE, IN `U_cantidad` INT)  INSERT INTO entregan VALUES (U_clave, U_rfc, U_numero, U_fecha, U_cantidad)$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `registrarMaterial` (IN `U_Clave` INT, IN `U_Descripcion` VARCHAR(40) CHARSET utf8, IN `U_Precio` FLOAT, IN `U_Impuesto` FLOAT)  INSERT INTO materiales VALUES (U_clave, U_Descripcion, U_Precio, U_impuesto)$$
...
(1000, 'GGGG800101', 5000, '2000-05-23', 20),
...
(1000, 'Varilla 3/16', 200, 10),
(1010, 'Varilla 4/32', 215, 11.5),
(1020, 'Varilla 3/17', 230, 13),
(1030, 'Varilla 4/33', 245, 14.5),
(1040, 'Varilla 3/18', 260, 16),
(1050, 'Varilla 4/34', 275, 17.5),
(1060, 'Varilla 3/19', 290, 19),
(1070, 'Varilla 4/35', 305, 20.5),
(1080, 'Ladrillos rojos', 150, 5),
(1090, 'Ladrillos grises', 135, 3.5),
(1100, 'Block', 130, 3),
(1110, 'Megablock', 140, 4),
(1120, 'Sillar rosa', 200, 10),
(1130, 'Sillar gris', 210, 11),
(1140, 'Cantera blanca', 300, 20),
(1150, 'Cantera gris', 1310, 121),
(1160, 'Cantera rosa', 1520, 142),
(1170, 'Cantera amarilla', 330, 23),
(1180, 'Recubrimiento P1001', 300, 20),
(1190, 'Recubrimiento P1010', 320, 22),
(1200, 'Recubrimiento P1019', 340, 24),
(1210, 'Recubrimiento P1028', 350, 25),
(1220, 'Recubrimiento P1037', 380, 28),
(1230, 'Cemento ', 400, 30),
(1240, 'Arena', 300, 20),
(1250, 'Grava', 200, 10),
(1260, 'Gravilla', 190, 9),
(1270, 'Tezontle', 180, 8),
(1280, 'Tepetate', 134, 3.4),
(1290, 'Tubería 3.5', 300, 20),
(1300, 'Tubería 4.3', 310, 21),
(1310, 'Tubería 3.6', 320, 22),
(1320, 'Tubería 4.4', 330, 23),
(1330, 'Tubería 3.7', 340, 24),
(1340, 'Tubería 4.5', 350, 25),
(1350, 'Tubería 3.8', 360, 26),
(1360, 'Pintura C1010', 225, 12.5),
(1370, 'Pintura B1020', 225, 12.5),
(1380, 'Pintura C1011', 825, 72.5),
(1390, 'Pintura B1021', 225, 12.5),
(1400, 'Pintura C1011', 225, 12.5),
(1410, 'Pintura B1021', 225, 12.5),
(1420, 'Pintura C1012', 225, 12.5),
(1430, 'Pintura B1022', 225, 12.5),
(2000, 'Jabón', 225, 12.5),
(20000, 'Tacos', 110, 2);
